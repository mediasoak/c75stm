Fri 8 May 2026
This repo contains the source code for the Ortho C75 keyboard by Ortho_Studio (bilibili UID 2030339595).
I purchased the Ortho C75 from aliexpress (Store ID 1103675911). Apparently, it uses a XiuDi 75 PCB clone.
